...
This a redrawing of the NOAA "Mean Sea Level Trend" graphic for Portland. We
have added a 24 month (2 year) moving average.

## English Units Based on MLLW
```{r plot_slr_mllw, fig.width = 7, fig.height = 5}
...
## English Units Based on MLLW
```{r plot_slr_mllw_ppt, fig.width = 6, fig.height = 6}
