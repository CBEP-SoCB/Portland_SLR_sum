...
the data from the Portland Tide Gauge supports that idea.  We conclude that it
does not.  
...
"accelerating" SLR to be well supported by available data.
...
So, the slope for the most recent `r span` year period is lower than 13 of
